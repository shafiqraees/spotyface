...
/* ==========================================================================
   ...
   ========================================================================== */
	...
	public function has_portfolio($id) {

		$has = $this->db->has("portfolio", ["id" => $id]);		
    ...
    public function get_portfolio($id) {
		...
		$query = $this->db->select("portfolio", "*", ["id" => $id]);	
        foreach($query as $row){}		
     ...
     *
     */
    public function update_portfolio($description, $filename, $id) {
