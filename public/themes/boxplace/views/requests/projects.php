...
?>
        <?php foreach($data['p_pagination'] as $row) { 
		
		?>	
				
			 <a href="<?=$this->siteUrl()?>/project/<?=e($row["projectid"])?>/<?=e($row["slug"])?>" class="job-box wow fadeInDown" data-wow-delay="0ms" data-wow-duration="1500ms">
